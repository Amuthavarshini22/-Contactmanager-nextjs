        ...
        <div key={contact.id} className='p-4 border rounded-lg'>
            <div className='flex justify-between items-start'>
                ...
                <div className='flex items-center self-center gap-3'>
                    <Link href={`/contact/edit/${contact.id}`} className='flex items-center text-blue-600 gap-2 px-3 py-1 border-blue-300 rounded-md hover:border-blue-400 hover:bg-blue-100'>
